...
from graph_cbm.modeling.generalized_rcnn.backbone import resnet50_fpn_backbone
...
def create_model(num_classes, load_pretrain_weights=False):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="checkpoints/backbone/resnet50.pth",
